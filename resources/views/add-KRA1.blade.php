...
function showAddForm(option) {
    ...
    var part3 = document.getElementById('dynamic-form-container3');
    ...
    if (option === "criterionA") { //------------------------------------------------------------------
      ...
      // Student Evaluation -------------------------------------
        ...
        wrapElements([sel_stdEval_reason], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
          createDynamicLabel('AY 2019-2020', 'dynamic-form-container1');
        wrapElements([in_stdEval_1sem_q1, in_stdEval_2sem_q1], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
          createDynamicLabel('AY 2020-2021', 'dynamic-form-container1');
        wrapElements([in_stdEval_1sem_q2, in_stdEval_2sem_q2], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
          createDynamicLabel('AY 2021-2022', 'dynamic-form-container1');
        wrapElements([in_stdEval_1sem_q3, in_stdEval_2sem_q3], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
          createDynamicLabel('AY 2022-2023', 'dynamic-form-container1');
        wrapElements([in_stdEval_1sem_q4, in_stdEval_2sem_q4 ], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
      ...
      // Supervisor Evaluation -----------------------------------
        ...
        wrapElements([in_supEval_semDed], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        wrapElements([in_supEval_reason], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
          createDynamicLabel('AY 2019-2020', 'dynamic-form-container2');
        wrapElements([in_supEval_1sem_q1, in_supEval_2sem_q1], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
          createDynamicLabel('AY 2020-2021', 'dynamic-form-container2');
        wrapElements([in_supEval_1sem_q2, in_supEval_2sem_q2], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
          createDynamicLabel('AY 2021-2022', 'dynamic-form-container2');
        wrapElements([in_supEval_1sem_q3, in_supEval_2sem_q3], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
          createDynamicLabel('AY 2022-2023', 'dynamic-form-container2');
        wrapElements([in_supEval_1sem_q4, in_supEval_2sem_q4], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');

        //createDynamicCheckbox('supEval-SD1', 'Supervisor Evaluation Rating using prescribed template', 'dynamic-form-container');
    } 
        ...
        wrapElements([sel_kra1_cB], 'w-full md:w-4/5 px-3 mb-6 md:mb-0', 'dynamic-category-container');
      ...
      // Instructional Material -------------------------------------
        ...
        wrapElements([in_im_title_sole], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
        wrapElements([sel_im_type_sole], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
        wrapElements([in_im_reviewer_sole, in_im_pubrepo_sole], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
        wrapElements([in_im_datePubl_sole, in_im_dateApprv_sole], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
        ...
        wrapElements([in_im_title_co], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        wrapElements([sel_im_type_co], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        wrapElements([in_im_reviewer_co, in_im_pubrepo_co], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        wrapElements([in_im_datePubl_co, in_im_dateApprv_co], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        
        wrapElements([in_im_contribution_co], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
      ...
      wrapElements([sel_ap_type, in_ap_boardReso], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container3');
      wrapElements([sel_ap_acadYear, sel_ap_role], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container3');
        ...
        wrapElements([sel_kra1_cC], 'w-full md:w-4/5 px-3 mb-6 md:mb-0', 'dynamic-category-container');
        ...
        // Adviser ---------------------------------------------------
        createDynamicLabel('SPECIAL/CAPSTONE PROJECT', 'dynamic-form-container1');
          ...
          wrapElements([in_adv_CstdNum_q1, in_adv_CstdNum_q2, in_adv_CstdNum_q3, in_adv_CstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container1');

        createDynamicLabel('UNDERGRADUATE THESIS', 'dynamic-form-container1');
          ...
          wrapElements([in_adv_UstdNum_q1, in_adv_UstdNum_q2, in_adv_UstdNum_q3, in_adv_UstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container1');

        createDynamicLabel('MASTERS THESIS', 'dynamic-form-container1');
          ...
          wrapElements([in_adv_MstdNum_q1, in_adv_MstdNum_q2, in_adv_MstdNum_q3, in_adv_MstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container1');

        createDynamicLabel('DISSERTATION', 'dynamic-form-container1');
          ...
          wrapElements([in_adv_DstdNum_q1, in_adv_DstdNum_q2, in_adv_DstdNum_q3, in_adv_DstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container1');
        
        
        // Panel -----------------------------------------------------
        createDynamicLabel('SPECIAL/CAPSTONE PROJECT', 'dynamic-form-container2');
          ...
          wrapElements([in_adv_CstdNum_q1, in_adv_CstdNum_q2, in_adv_CstdNum_q3, in_adv_CstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container2');

        createDynamicLabel('UNDERGRADUATE THESIS', 'dynamic-form-container2');
          ...
          wrapElements([in_pan_UstdNum_q1, in_pan_UstdNum_q2, in_pan_UstdNum_q3, in_pan_UstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container2');

        createDynamicLabel('MASTERS THESIS', 'dynamic-form-container2');
          ...
          wrapElements([in_pan_MstdNum_q1, in_pan_MstdNum_q2, in_pan_MstdNum_q3, in_pan_MstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container2');

        createDynamicLabel('DISSERTATION', 'dynamic-form-container2');
          ...
          wrapElements([in_pan_DstdNum_q1, in_pan_DstdNum_q2, in_pan_DstdNum_q3, in_pan_DstdNum_q4], 'w-full md:w-1/4 px-3 mb-6 md:mb-0', 'dynamic-form-container2');
        ...
        wrapElements([in_ment_compeName], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container3');
        wrapElements([in_ment_sponsorOrg], 'w-full md:w-1/1 px-3 mb-6 md:mb-0', 'dynamic-form-container3');
        wrapElements([in_ment_awardName, in_ment_awardDate], 'w-full md:w-1/2 px-3 mb-6 md:mb-0', 'dynamic-form-container3');
    }
}
</script>
<!------------------------------------------------------------------------------------------------------->
