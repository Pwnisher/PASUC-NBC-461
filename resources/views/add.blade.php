...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        ...
        let dynamicSelectsCreated = false;

        function showAddForm(option) {
            var addFormContent = document.getElementById("form-content");
            ...
            if (option === "criterionA") {
                ...
                if (!dynamicSelectsCreated) {
                    ...
                    dynamicSelectsCreated = true; // Set the flag to true after creating dynamic selects
                }
