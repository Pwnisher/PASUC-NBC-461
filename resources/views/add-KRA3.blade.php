...
<body class="bg-ghostwhite">
  <div class="flex h-screen flex-col ">
    ...
    <h2 class="text-center mt-4">
      ...
      <a href="#" onclick="showAddForm('criterionD')">•   Criterion D   •</a>
    </h2>
              ...
              <form>
                ...
                <div class="md:col-span-5 text-right">
                  <div class="inline-flex items-end">
                    <a href="{{ url('/eqar') }}">
                    <button id="SaveButton"  onclick="navigateToEqarPage()" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Cancel</button> </a>
